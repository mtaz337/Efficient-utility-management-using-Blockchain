...
<nav id="navbar1" class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent1">
     <ul class="nav navbar-nav ml-auto">
	    ...
	    <li class="nav-item"><a class="nav-link active" id="active2" href="Buy.php">Buy</a></li>
    ...
    <div class="col-md-4 jumbotron" >
			<form method="post" action="Buy.php">
					...
					<h2>Buy Energy</h2>
							...
							<input style="display:none" type="text" name="user_power_balance_id" id='_PoweID'  value="<?php echo $user_power_balance_id; ?>" class="form-control" >
                            <input style="display:none"  type="text" id='customer_id' name="customer_id" class="form-control" value="<?php echo $_SESSION['user_id']; ?>"  >
                            <input style="display:none"  type="text" id='provider_id' name="provider_id" class="form-control" value="<?php echo $provider_id; ?>"  >
                            <input style="display:none"  type="text" id='device' name="device" class="form-control" value="<?php echo $device ; ?>"  >
				  <div class="form-group">
					<label for="email">Customer Name:</label>
					<input type="text" class="form-control"  id='' value="<?php echo $_SESSION['username']; ?>" disabled="">
				  </div>  
				  <div class="form-group">
					<label for="email">Customer Phone:</label>
					<input type="text" class="form-control"  id='' value="<?php echo $_SESSION['phone']; ?>" disabled="">
				  </div>  
				  <div class="form-group">
					<label for="email">Customer Email:</label>
					<input type="text" class="form-control"  id='' value="<?php echo $_SESSION['email']; ?>" disabled="">
				  </div>   
				  <div class="form-group">
					<label for="email">Customer Address:</label>
					<input type="text"  class="form-control"  id='' value="<?php echo $_SESSION['address']; ?>" disabled="">
				  </div>  
				  
				  <div class="form-group">
					<label for="exampleFormControlSelect1">Plant type:</label>
					<select  required  id='plant_type' class="form-control" name="plant_type"  >
					...
					<input required  id='power_amount' type="text" class="form-control" name="power_amount" value="<?php echo $power_amount; ?>" >
				  </div>  
				  
					<div class="form-group">
					<label for="email">Electricity charge per 1kw: (Coin)</label>
					<input required  id='power_per_kw' list="power_per_list" class="form-control required" value="<?php echo $power_per_kw; ?>"  type="text" name="power_per_kw" placeholder="Price *"  >
...
<?php if($enable_update=='1'){echo '<button type="submit"   name="buy_now"  class="btn btn-success">Buy</button>';}
else{echo ' ';}?>				  
					...
					<?php						 		
						...
						{  
							...
							<td>'.$sold_out.'<b>⌚ Created :</b> ' .$row[$i]['created'].' <br>';
								...
								$provider_id=$row[$i]['provider_id'];
								$query1="select * from users WHERE id='$provider_id'";
				    ...
				    echo '</td>
							...
							<td > 
								 <form   method="POST"   >
									...
									<input style="display:none" type="text" name="provider_id"  value="'.$row[$i]['provider_id'].'" class="form-control" >
